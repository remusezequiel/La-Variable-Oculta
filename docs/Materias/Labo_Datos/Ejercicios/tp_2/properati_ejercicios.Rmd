...
sd_menos = table(new_df[new_df$preciom2 <= (promedio - sd),]$property_type)
sd_mas = table(new_df[new_df$preciom2 <= (promedio + sd),]$property_type)

precio_may_promedio = table(new_df[new_df$preciom2 > (promedio),]$property_type)
precio_men_promedio = table(new_df[new_df$preciom2 < (promedio),]$property_type)
...
cat("\n","Precios mayor al promedio", "\n")
prop.table(precio_may_promedio)
cat("\n","Precios menos al promedio","\n")
prop.table(precio_men_promedio)
